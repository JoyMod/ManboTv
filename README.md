<div align="center">
  <img src="public/logo.png" alt="ManboTV Logo" width="120" />
  <h1>ManboTV</h1>
  <p><strong>前后端分离的影视聚合项目</strong></p>
  <p>Next.js 14 + Go + Gin + Redis · 多源聚合 · HLS 代理 · Docker 部署</p>
...
ManboTV 是基于 MoonTV 思路继续重构的版本，但已经不是简单换皮。

这个仓库的重点很明确：

- 用 Go 后端接管搜索、详情、图片代理、播放代理这些高频链路
- 把页面首屏从“前端自己拼很多请求”改成后端聚合接口
- 让项目更适合 Docker、自建机、NAS、OpenWRT 这类实际部署环境
...
- Go 后端更适合高并发 I/O 场景
- 多源搜索并发拉取资源站，不再只靠前端层拼请求
- 搜索页、频道页、播放页都已有 bootstrap 聚合接口
- 图片代理、海报恢复、m3u8 代理放到后端后，首屏更轻
...
| 首页 / 频道页 | 搜索 / 播放页 | 后台 / 管理页 |
| --- | --- | --- |
| <img src="public/screenshot1.png" alt="ManboTV Screenshot 1" width="100%" /> | <img src="public/screenshot2.png" alt="ManboTV Screenshot 2" width="100%" /> | <img src="public/screenshot3.png" alt="ManboTV Screenshot 3" width="100%" /> |
